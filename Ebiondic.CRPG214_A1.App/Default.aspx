<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="CPRG214.Assignment1.App._Default" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <section class="mt-3">
        <h2 class="text-center mb-2">
            Welcome to Inland Marina
        </h2>

        <img src="Media/marina1.jpg" alt="Photo by Jeriden Villegas on Unsplash" class="emphasis-pic"/>

        <p class="text-center">
            Located on the south shore Inland Lake, we're just a small commute from major centers in the south west.
        </p>

        <img src="Media/marina2.jpg" alt="Photo by Neil and Zulma Scott on Unsplash" class="emphasis-pic"/>
