...
<asp:Panel ID="Panel1" runat="server" Height="130px" Width="130px" BorderStyle="Solid" BackColor="#E1FFFF" BorderColor="#3399FF" CssClass="d-flex flex-column align-items-center boat-bg-2">
